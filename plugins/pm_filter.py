...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/Animepiratesmovies"),
                InlineKeyboardButton("Series ⭕️", url="https://t.me/animepirateschannel")
            ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/Animechannel90'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/animepirateschannel')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/animegroup99')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⭕️ Updates', url='https://t.me/Animechannel90'),
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/Animepiratesmovies')
            ],[
        ...
        buttons = [[
            InlineKeyboardButton('⭕ Status', url='https://t.me/animegroup99'),
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/animepirateschannel")
    ])
